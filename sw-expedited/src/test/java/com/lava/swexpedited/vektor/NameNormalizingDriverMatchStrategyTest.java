...
class NameNormalizingDriverMatchStrategyTest {
    ...
    void match_exactName_matches() {
        Optional<String> matched = strategy.match("Warren Ruawhare", List.of(driver("samsara-1", "Warren Ruawhare")));
    ...
    void match_reversedWordOrder_stillMatches() {
        Optional<String> matched = strategy.match("Ruawhare Warren", List.of(driver("samsara-1", "Warren Ruawhare")));
    ...
    void match_noCandidateMatches_isEmpty() {
        Optional<String> matched = strategy.match("Warren Ruawhare", List.of(driver("samsara-1", "Kelly Dunn")));
    ...
    @Test
    void match_noDriverName_isEmpty() {
        Optional<String> matched = strategy.match(null, List.of(driver("samsara-1", "Warren Ruawhare")));
    ...
    void match_candidateWithNullName_isSkippedRatherThanThrowing() {
        Optional<String> matched = strategy.match(
                "Warren Ruawhare", List.of(driver("samsara-1", null), driver("samsara-2", "Warren Ruawhare")));
