 ...
 * {@code google.maps.geometry.encoding.decodePath}. {@code encodedPolyline}/{@code distanceMeters}/{@code duration} are
 * null - independently of {@code stops}/{@code startingPosition}, which always reflect Vektor's data - when Google
 * couldn't find a drivable route through this manifest's waypoints; see {@code ManifestRouteServiceImpl}'s javadoc.
 */
