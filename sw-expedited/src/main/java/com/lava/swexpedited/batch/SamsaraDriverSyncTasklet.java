...
public class SamsaraDriverSyncTasklet extends SamsaraTasklet implements Tasklet {
    ...
    public @Nullable RepeatStatus execute(StepContribution contribution, ChunkContext chunkContext) {
        List<SamsaraDriverWithRaw> driversWithRaw = samsaraFleetClient.fetchDrivers();
        List<SamsaraDriverRow> driverRows = driversWithRaw.stream()
                .map(SamsaraDriverSyncTasklet::toDriverRow)
                .toList();
        samsaraDriverRepository.replaceAll(driverRows);
        ...
        List<SamsaraDriverVehicleAssignmentRow> assignmentRows =
                toAssignmentRows(driversWithRaw, samsaraFleetClient.fetchDriverVehicleAssignments(driverIds));
        samsaraDriverVehicleAssignmentRepository.replaceAll(assignmentRows);
